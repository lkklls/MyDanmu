...
public class ImageLoader {
	...
	public boolean isCached(String requestUrl, int maxWidth, int maxHeight) {
		return isCached(requestUrl, maxWidth, maxHeight,DEFAULT_SCALE_TYPE);
	}
	...
	public ImageContainer get(String requestUrl, final ImageListener listener) {
		return get(requestUrl, listener, DEFAULT_MAX_WIDTH, DEFAULT_MAX_HEIGHT);
	}

	public void remove(String requestUrl) {
		String cacheKey = getCacheKey(requestUrl, DEFAULT_MAX_WIDTH, DEFAULT_MAX_HEIGHT,DEFAULT_SCALE_TYPE);
		mCache.removeBitmap(cacheKey);
	}


	/**
	 * Equivalent to calling {@link #get(String, ImageListener, int, int, ScaleType)} with
	 * {@code Scaletype ==DEFAULT_SCALE_TYPE}.
	 */
	public ImageContainer get(String requestUrl, ImageListener imageListener,
							  int maxWidth, int maxHeight) {
		return get(requestUrl, imageListener, maxWidth, maxHeight,DEFAULT_SCALE_TYPE);
	}
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener,
		...
		if(cachedBitmap!=null){
			if(cachedBitmap.isRecycled()){//图片回收的话就需要重新获取图片,而不是返回回收的bitmap
				mCache.removeBitmap(cacheKey);
			}else {
...
//		if (cachedBitmap != null) {
//			Log.e("1","cachedBitmap:"+cachedBitmap+"  isRecycled:"+cachedBitmap.isRecycled()+" url:"+requestUrl);
//			// Return the cached bitmap.
//			ImageContainer container = new ImageContainer(cachedBitmap, requestUrl, null, null);
//			imageListener.onResponse(container, true);
//			return container;
