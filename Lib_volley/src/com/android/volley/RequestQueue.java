...
public class RequestQueue {
    ...
    /**  任务完成的回调接口  Callback interface for completed requests. */
    public static interface RequestFinishedListener<T> {
        /** Called when a request has finished processing. */
        public void onRequestFinished(Request<T> request);
    }

    /**  原子操作的Integer的类,线程安全的加减操作接口，记录队列中当前的请求数目  Used for generating monotonically-increasing sequence numbers for requests. */
    ...
    /** 默认用于调度的线程池数目  Number of network request dispatcher threads to start. */
