...
public class SystemBarTintManager {
    ...
    public static void setActivityBar(Activity activity, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
        ...
        //华为mate9适配HONOR
        if (Build.VERSION.SDK_INT >= 23 && !((Build.BRAND.equals("HUAWEI")||Build.BRAND.equals("HONOR"))&&Build.VERSION.SDK_INT<26)) {
     ...
     * @param activity
     * @param color
     * @param modifyBackgroud 是否需要 修改状态栏背景
     */
    public static void setActivityBar(Activity activity, int color, boolean isFullScreen, boolean modifyBackgroud) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT&&modifyBackgroud) {
            setTranslucentStatus(activity, true);
        }
        SystemBarTintManager tintManager = new SystemBarTintManager(activity);
        tintManager.setStatusBarTintEnabled(true);
...
//            window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
    ...
    public static void setActivityBar(Activity activity, Drawable color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setTranslucentStatus(activity, true);
        }
        SystemBarTintManager tintManager = new SystemBarTintManager(activity);
     ...
     * @return
     */
    public static boolean canModifyStatusBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= 23) {
            return true;
        }
        if (setMiuiStatusBarForVersion(activity, true) || setMeizuStatusBarDarkIcon(activity, true)) {
            return true;
        }
    ...
    public static boolean setMiuiStatusBarForVersion(Activity activity, boolean darkmode) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            return setMiuiStatusBarDarkMode2(activity, darkmode);
        } else {
    ...
    //小米手机状态栏字体样式修改,适配6.0版本以上
    public static boolean setMiuiStatusBarDarkMode2(Activity activity, boolean darkmode) {
